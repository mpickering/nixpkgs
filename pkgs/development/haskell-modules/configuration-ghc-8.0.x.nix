...
self: super: {
  ...
  proto-lens = pkgs.haskell.lib.addBuildTool super.proto-lens pkgs.protobuf3_2;
  proto-lens-descriptors = pkgs.haskell.lib.addBuildTool super.proto-lens-descriptors pkgs.protobuf3_2;
  proto-lens-protoc = pkgs.haskell.lib.addBuildTool super.proto-lens-protoc pkgs.protobuf3_2;
  proto-lens-combinators = pkgs.haskell.lib.addBuildTool super.proto-lens-combinators pkgs.protobuf3_2;
	...
	kythe-proto = pkgs.haskell.lib.addBuildTool (pkgs.haskell.lib.doJailbreak (super.callPackage ./kythe-proto.nix { kythe = pkgs.kythe; })) pkgs.protobuf3_2;
